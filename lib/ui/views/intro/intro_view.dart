...
class IntroView extends StatelessWidget {
        ...
        PageViewModel(
          ...
          bodyWidget: Column(
            children: [
              ...
              Text('Foodie',
                  style:
                      AppStyle.subtitle2.copyWith(fontWeight: FontWeight.bold)),
              Text(
                'Are you ready to eat ??',
                style: AppStyle.body1.copyWith(
                  fontWeight: AppStyle.regularBold,
                ),
              ),
            ],
          ),
        ...
        PageViewModel(
          ...
          bodyWidget: Column(
            children: [
              ...
              Text(
                'Lets find your favorite and delicious food !!!',
        ...
        PageViewModel(
          ...
          bodyWidget: Column(
            children: [
              ...
              Text('Varcant',
                  style:
                      AppStyle.subtitle3.copyWith(fontWeight: FontWeight.bold)),
              Text('nanda.kista@gmail.com',
                  style: TextStyle(fontWeight: AppStyle.semiBold)),
            ],
          ),
        ),
      ],
  ...
  void _onIntroEnd(context) async {
    ...
    Get.offAllNamed(RestaurantListView.route);
  }
