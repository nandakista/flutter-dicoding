...
class RestaurantDetailView extends GetView<RestaurantDetailController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: SkyAppBar.primary(title: controller.restaurant?.name),
      body: SafeArea(
        child: SkyView(
          ...
          child: Column(
            ...
            children: [
              SkyImage(
                url: controller.restaurant!.imageUrl.toString(),
                height: 300,
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 8),
                            Text(
                              '${controller.restaurant?.menus?.drinks?.length} ${'txt_foods'.tr}',
                              style: AppStyle.body1
                                  .copyWith(fontWeight: FontWeight.w400),
                            ),
                          ],
                        ...
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 8),
                            Text(
                              '${controller.restaurant?.menus?.drinks?.length} ${'txt_drinks'.tr}',
                              style: AppStyle.body1
                                  .copyWith(fontWeight: FontWeight.w400),
                            ),
                          ],
              ...
              SingleChildScrollView(
                ...
                child: Row(
                  children: List.generate(
                    controller.restaurant?.menus?.drinks?.length ?? 0,
                    (index) {
                      final item = controller.restaurant?.menus?.drinks?[index];
                      return Container(
